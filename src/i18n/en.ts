...
export const en: Record<string, string> = {
  ...
  'league.heading': 'Fantasy leagues',
  'league.create.heading': 'Create a league',
  'league.create.name': 'League name',
  'league.create.submit': 'Create',
  'league.join.heading': 'Join a league',
  'league.join.code': 'League code',
  'league.join.submit': 'Join',
  'league.join.hint': 'Enter the code a friend shared with you.',
  'league.mine.heading': 'My leagues',
  'league.mine.empty': 'You are not in any league yet. Create one or join with a code.',
  'league.owner': 'Owner',
  'league.members': '{count} members',
  'league.code.share': 'Share this code to invite others:',
  'league.standings.heading': 'Standings',
  'league.col.rank': '#',
  'league.col.user': 'Player',
  'league.col.entries': 'Entries',
  'league.col.points': 'Points',
  'league.leave': 'Leave league',
  'league.leave.confirm': 'Leave this league?',
  'league.delete': 'Delete league',
  'league.delete.confirm': 'Delete this league for everyone? This cannot be undone.',
  'league.back': 'All leagues',
  'league.you': 'You',
  'league.viewPlan': 'View plan',
  'league.memberPlan.heading': "{name}'s squad",
  'league.memberPlan.noPlans': 'No plans to show yet — squads become visible once a match kicks off.',
  'league.error.notFound': 'No league found with that code.',
  'league.error.nameRequired': 'Please enter a league name.',
  'league.error.codeRequired': 'Please enter a code.',
  'league.error.codeInvalid': 'That code is not valid.',
  'league.error.ownerLeave': 'You own this league — delete it instead of leaving.',
